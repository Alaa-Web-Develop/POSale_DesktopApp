...
namespace POS_Demo {
    ...
    public partial class POSTutDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Name, string Code, int Quantity, string Notes, decimal Price) {
...
namespace POS_Demo.POSTutDataSet2TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Code], [Quantity], [Notes], [Price]) VALUE" +
                "S (@Name, @Code, @Quantity, @Notes, @Price);\r\nSELECT id, Name, Code, Quantity, N" +
                "otes, Price FROM Products WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Code] = @Code, [Quantity] = @Quantity, [Notes] = @Notes, [Price] = @Price WHERE (([id] = @Original_id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Notes = 1 AND [Notes] IS NULL) OR ([Notes] = @Original_Notes)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT id, Name, Code, Quantity, Notes, Price FROM Products WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Name, Code, Quantity, Notes, Price FROM dbo.Products";
        ...
        public virtual int Fill(POSTutDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual POSTutDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            POSTutDataSet2.ProductsDataTable dataTable = new POSTutDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(POSTutDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_Name, string Original_Code, global::System.Nullable<int> Original_Quantity, string Original_Notes, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(string Name, string Code, global::System.Nullable<int> Quantity, string Notes, global::System.Nullable<decimal> Price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Code, global::System.Nullable<int> Quantity, string Notes, global::System.Nullable<decimal> Price, int Original_id, string Original_Name, string Original_Code, global::System.Nullable<int> Original_Quantity, string Original_Notes, global::System.Nullable<decimal> Original_Price, int id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Code, global::System.Nullable<int> Quantity, string Notes, global::System.Nullable<decimal> Price, int Original_id, string Original_Name, string Original_Code, global::System.Nullable<int> Original_Quantity, string Original_Notes, global::System.Nullable<decimal> Original_Price) {
            return this.Update(Name, Code, Quantity, Notes, Price, Original_id, Original_Name, Original_Code, Original_Quantity, Original_Notes, Original_Price, Original_id);
        }
    }
